"""Windows RegisterHotKey integration through Qt's native event filter."""
...
class GlobalHotkeyManager(QObject, QAbstractNativeEventFilter):
    """Register Ctrl+Shift+Q and emit a Qt signal on WM_HOTKEY."""
    ...
    def __init__(
        ...
        if self._register_func is None and os.name == "nt":
    ...
    def register(self) -> bool:
        """Register the hotkey and install the native event filter."""
    ...
    def unregister(self) -> None:
        """Unregister the Windows hotkey; safe to call more than once."""
    ...
    def handle_hotkey(self, hotkey_id: int) -> bool:
        """Route a matching hotkey ID; also used by headless tests."""
