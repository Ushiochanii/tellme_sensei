...
_EN = {
    ...
    "settings.ai_title": "AI Models",
    "settings.ai_description": "Choose independent Text and Vision AI providers and models.",
    "settings.text_ai_title": "Text AI",
    "settings.text_ai_description": "Used for Text / OCR and Context + Question analysis.",
    "settings.vision_ai_title": "Vision AI",
    "settings.vision_ai_description": "Used for direct screenshot analysis.",
    "settings.provider_credentials": "Provider Credentials",
    "settings.manage_credentials": "Manage credentials",
    "settings.credential_configured": "Credential configured",
    "settings.credential_missing": "Credential required",
    "settings.provider": "Provider",
    "settings.model": "Model",
    "settings.endpoint": "Endpoint",
    "settings.custom_model_id": "Custom model ID...",
    "settings.provider_api_key_placeholder": "Enter the selected provider API Key",
    "settings.test_text_ai": "Test Text AI",
    "settings.test_vision_ai": "Test Vision AI",
    "settings.text_ai_connection_success": "Text AI connection successful.",
    "settings.vision_ai_connection_success": "Vision AI connection successful.",
    "settings.wait_operation_before_ai": "Wait for the active operation to finish before testing AI.",
    "settings.enter_provider_api_key": "Enter an API Key for the selected provider before testing.",
    "settings.provider_api_key_env_override": (
        "The current {provider} API Key is overridden by the {environment_name} environment variable. "
        "Saving a different key will not change the key currently in use."
    ),
    "settings.provider_endpoint_env_override": (
        "The current {provider} endpoint is overridden by the {environment_name} environment variable."
    ),
    ...
    "error.ai_empty_ocr": "OCR did not recognize usable text; the selected Text AI cannot be requested.",
    "error.ai_empty_question_ocr": "Question OCR did not recognize usable text; the selected Text AI cannot be requested.",
    "error.ai_empty_image": "The screenshot is empty; the selected Vision AI cannot be requested.",
    "error.ai_png_only": "Vision Mode currently supports PNG screenshots only.",
    "error.qwen_missing_api_key": "No Qwen API Key is configured. Save one in Settings.",
    "error.qwen_missing_api_key_env": "No Qwen API Key is configured. Save one in Settings or check the .env file.",
    "error.qwen_missing_openai": "The openai dependency is missing. Run python -m pip install -r requirements.txt.",
    "error.qwen_401": "The Qwen API Key is invalid (401). Check the API Key in Settings.",
    "error.qwen_403": "Qwen API access was denied (403). Check account permissions or the API Key.",
    "error.qwen_429": "Qwen API requests are too frequent (429). Please try again later.",
    "error.qwen_5xx": "Qwen is temporarily unavailable ({status_code}). Please try again later.",
    "error.qwen_timeout": "The Qwen API request timed out. Check the network and try again.",
    "error.qwen_connection": "Could not connect to the Qwen API. Check the network connection.",
    "error.qwen_generic": "Qwen API request failed. Check the network, API Key, and model configuration.",
    "error.qwen_empty_answer": "Qwen returned an empty answer.",
    "error.zai_missing_api_key": "No Z.AI API Key is configured. Save one in Settings.",
    "error.zai_missing_api_key_env": "No Z.AI API Key is configured. Save one in Settings or check the .env file.",
    "error.zai_missing_openai": "The openai dependency is missing. Run python -m pip install -r requirements.txt.",
    "error.zai_401": "The Z.AI API Key is invalid (401). Check the API Key in Settings.",
    "error.zai_403": "Z.AI API access was denied (403). Check account permissions or the API Key.",
    "error.zai_429": "Z.AI API requests are too frequent (429). Please try again later.",
    "error.zai_5xx": "Z.AI is temporarily unavailable ({status_code}). Please try again later.",
    "error.zai_timeout": "The Z.AI API request timed out. Check the network and try again.",
    "error.zai_connection": "Could not connect to the Z.AI API. Check the network connection.",
    "error.zai_generic": "Z.AI API request failed. Check the network, API Key, and model configuration.",
    "error.zai_empty_answer": "Z.AI returned an empty answer.",
...
_ZH_CN = {
    ...
    "settings.ai_title": "AI 模型",
    "settings.ai_description": "分别选择 Text 和 Vision 使用的 AI 服务商与模型。",
    "settings.text_ai_title": "Text AI",
    "settings.text_ai_description": "用于 Text / OCR 与 Context + Question 分析。",
    "settings.vision_ai_title": "Vision AI",
    "settings.vision_ai_description": "用于直接分析题目截图。",
    "settings.provider_credentials": "服务商凭据",
    "settings.manage_credentials": "管理凭据",
    "settings.credential_configured": "凭据已配置",
    "settings.credential_missing": "需要配置凭据",
    "settings.provider": "服务商",
    "settings.model": "模型",
    "settings.endpoint": "Endpoint",
    "settings.custom_model_id": "自定义模型 ID…",
    "settings.provider_api_key_placeholder": "输入当前服务商 API Key",
    "settings.test_text_ai": "测试 Text AI",
    "settings.test_vision_ai": "测试 Vision AI",
    "settings.text_ai_connection_success": "Text AI 连接成功。",
    "settings.vision_ai_connection_success": "Vision AI 连接成功。",
    "settings.wait_operation_before_ai": "请等待当前操作完成后再测试 AI。",
    "settings.enter_provider_api_key": "请先为当前服务商输入 API Key。",
    "settings.provider_api_key_env_override": (
        "当前 {provider} API Key 由 {environment_name} 环境变量覆盖。保存其他 Key 不会改变当前实际使用的 Key。"
    ),
    "settings.provider_endpoint_env_override": (
        "当前 {provider} Endpoint 由 {environment_name} 环境变量覆盖。"
    ),
    ...
    "error.ai_empty_ocr": "OCR 未识别到有效文字，无法请求当前 Text AI。",
    "error.ai_empty_question_ocr": "Question OCR 未识别到有效文字，无法请求当前 Text AI。",
    "error.ai_empty_image": "截图内容为空，无法请求当前 Vision AI。",
    "error.ai_png_only": "Vision Mode 当前只支持 PNG 截图。",
    "error.qwen_missing_api_key": "未配置 Qwen API Key，请在设置中保存 API Key。",
    "error.qwen_missing_api_key_env": "未配置 Qwen API Key，请在设置中保存 API Key，或检查 .env 配置。",
    "error.qwen_missing_openai": "未安装 openai 依赖，请先执行 python -m pip install -r requirements.txt。",
    "error.qwen_401": "Qwen API Key 无效（401），请前往设置检查 API Key。",
    "error.qwen_403": "Qwen API 访问被拒绝（403），请检查账户权限或 API Key。",
    "error.qwen_429": "Qwen API 请求过于频繁（429），请稍后重试。",
    "error.qwen_5xx": "Qwen 服务暂时不可用（{status_code}），请稍后重试。",
    "error.qwen_timeout": "Qwen API 请求超时，请检查网络后重试。",
    "error.qwen_connection": "连接 Qwen API 失败，请检查网络连接。",
    "error.qwen_generic": "Qwen API 请求失败，请检查网络、API Key 和模型配置。",
    "error.qwen_empty_answer": "Qwen 返回了空答案。",
    "error.zai_missing_api_key": "未配置 Z.AI API Key，请在设置中保存 API Key。",
    "error.zai_missing_api_key_env": "未配置 Z.AI API Key，请在设置中保存 API Key，或检查 .env 配置。",
    "error.zai_missing_openai": "未安装 openai 依赖，请先执行 python -m pip install -r requirements.txt。",
    "error.zai_401": "Z.AI API Key 无效（401），请前往设置检查 API Key。",
    "error.zai_403": "Z.AI API 访问被拒绝（403），请检查账户权限或 API Key。",
    "error.zai_429": "Z.AI API 请求过于频繁（429），请稍后重试。",
    "error.zai_5xx": "Z.AI 服务暂时不可用（{status_code}），请稍后重试。",
    "error.zai_timeout": "Z.AI API 请求超时，请检查网络后重试。",
    "error.zai_connection": "连接 Z.AI API 失败，请检查网络连接。",
    "error.zai_generic": "Z.AI API 请求失败，请检查网络、API Key 和模型配置。",
    "error.zai_empty_answer": "Z.AI 返回了空答案。",
