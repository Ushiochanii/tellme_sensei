...
Status: Accepted for v0.9.0 implementation
...
The next process step is to create one umbrella implementation Issue and begin Phase 1 from the then-current `main`. Productization roadmap Issue #62 remains an independent idea and is not a prerequisite for this refactor.
